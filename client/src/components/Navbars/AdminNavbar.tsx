        ...
        <nav className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/30">
            ...
            {mobileMenuOpen && (
                <div className="lg:hidden py-4 border-t border-slate-200 dark:border-zinc-800 flex flex-col gap-2">
                    ...
                    <NavLink to="/admin" onClick={() => setMobileMenuOpen(false)} className={navLinkClass}>Admin Portal</NavLink>
